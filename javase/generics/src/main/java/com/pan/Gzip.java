...
//            ApiLogger.error("gzip uncompress error.", e);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("压缩后字符串：" + Gzip.compress(str).toString().length());
//        System.out.println("解压缩后字符串：" + Gzip.newStringUtf8(Gzip.uncompress(Gzip.compress(str))));
//        System.out.println("解压缩后字符串：" + Gzip.uncompressToString(Gzip.compress(str)));
    }
}
